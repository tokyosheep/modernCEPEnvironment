 ...
 * getting layers name
 */
var getLayers = function getLayers(activeDoc) {
  var layers = [];

  for (var l = 0; l < activeDoc.layers.length; l++) {
    layers[l] = {
      type: 'layer',
...
var report = {
   ...
   */
  inspectObj: function inspectObj(obj) {
    if (true) {
      for (var p in obj) {
        try {
          $.writeln('key :' + p);
...
__webpack_require__(/*! ../polyfill/json2 */ "./polyfill/json2.js");

__webpack_require__(/*! ../polyfill/padStart */ "./polyfill/padStart.js");
...
var doSomething = function doSomething(msg) {
  $.level = 1;

  _log["default"].log('doing');

  _log["default"].log(msg);
...
var test = function test() {
  ...
  _log["default"].log(100);

  _log["default"].log(n.padStart(2, '0'));

  _log["default"].log(Math.trunc(13.2343));
};
/*
